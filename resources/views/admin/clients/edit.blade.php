...
<div id="confirmationModal" class="fixed inset-0 z-50 hidden items-center justify-center bg-black bg-opacity-50">
    <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-md">
        ...
        <p class="text-gray-600 dark:text-gray-300 ">Voulez-vous vraiment enregistrer les modifications de ce client ?</p>
        <p id="error-message" class="text-red-600 mt-1 hidden mb-6">Les mots de passe ne correspondent pas.</p>
