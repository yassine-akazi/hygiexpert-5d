...
<!-- Bloc où s'affiche le champ message -->
<div id="contactSection" 
     class="hidden fixed right-6 bottom-24  bg-white p-5 rounded-2xl shadow-2xl z-50 w-80 border border-gray-200  transition-all duration-300 animate-[fadeIn_0.3s_ease-out]">
  
  <!-- Bouton de fermeture -->
  <div class="flex justify-between items-center mb-4">
    <h3 class="text-lg font-semibold ">Envoyer un message</h3>
    <button onclick="closeContactSection()" class="text-gray-400 hover:text-red-500 text-xl font-bold">&times;</button>
  </div>
  ...
  <input id="whatsappMessage" 
         ...
         class="w-full p-3 rounded-xl border pb-14 border-gray-300  focus:ring-2 focus:ring-green-500 focus:outline-none bg-gray-50 text-gray-900  placeholder-gray-400 dark:placeholder-gray-500 mb-4 transition" />

  <!-- Bouton envoyer -->
  <button onclick="sendWhatsApp()" 
          class="w-full bg-green-500 hover:bg-green-600 text-white font-medium py-2.5 px-4 rounded-xl shadow-md transition">
...
<div class="fixed bottom-6 right-6 z-50">
  <button onclick="toggleContactSection()" class="p-2 bg-green-500 rounded-full shadow-lg hover:bg-green-600 transition" aria-label="Contact WhatsApp">
